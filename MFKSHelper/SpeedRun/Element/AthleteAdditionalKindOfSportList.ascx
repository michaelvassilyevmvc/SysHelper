<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AthleteAdditionalKindOfSportList.ascx.cs" Inherits="MFKSHelper.SpeedRun.Element.AthleteAdditionalKindOfSportList" %>
